    ...
    return (
        <div style = {{display : 'flex', marginTop: '100px'}} >
            <div className = "row">
                ...
                <div>
                    <p><h2 style = {{marginLeft : '20px'}}>Dish Name : <span style = {{color: 'red', fontSize : '100%'}}>{label}</span></h2></p>
                    <a href = {url} className = "btn btn-primary" style = {{color : 'white'}}>Click here for Details</a>
                </div>
            </div>
