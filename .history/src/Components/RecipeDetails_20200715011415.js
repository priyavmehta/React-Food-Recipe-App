        ...
        <div style = {{display : 'flex', marginTop: '100px'}} >
            <div className = "row">
                ...
                <div style = {{marginLeft : '20px'}}>
                    ...
                    <a href = {url} className = "btn btn-success" style = {{color : 'white'}}>Click here for similar dish Details</a>
                    <a href = {shareAs} className = "btn btn-danger" style = {{color : 'white'}}>Click here for complete Details</a>
                </div>
            </div>
