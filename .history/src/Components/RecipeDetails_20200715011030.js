        ...
        <div style = {{display : 'flex', marginTop: '100px'}} >
            <div className = "row">
                ...
                <div style = {{marginLeft : '20px'}}>
                    ...
                    <a href = {uri} className = "btn btn-success" style = {{color : 'white'}}>Click here for uri Details</a>
                    <a href = {shareAs} className = "btn btn-failure" style = {{color : 'white'}}>Click here for shareAs Details</a>
                </div>
            </div>
